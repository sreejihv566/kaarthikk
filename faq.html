...
<body>
    ...
    <main>
        ...
        <section class="faq-main-wrapper section-padding">
            <div class="container custom-container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title section-title--style_2 text-center mb-4">
                            <h2 class="h1 title">General Question</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <!-- page main wrapper start -->
        <section class="faq-main-wrapper section-padding pt-0">
            <div class="container custom-container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title section-title--style_2 text-center mb-4">
                            <h2 class="h1 title">Payment & Gift card</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row mtn-40">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="footer-single-widget mt-40">
                            ...
                            <div class="widget-body">
                                <p class="desc">Ideas es to obtain pain of because the because occasionallyght ocean he and chunks as necessary</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <!-- footer single widget start -->
                        <div class="footer-single-widget mt-40">
                            <h3 class="widget-title">Twitter Post</h3>
                            <div class="widget-body">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="copyright-text text-center">
                    <p>Copyright © <a href="https://hasthemes.com">Karen</a> 2019</p>
                </div>
            </div>
        </div>
    </footer>
